    ...
    public static class UserSeed
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<User>().HasData(
                ...
                new User { Id = 1, Password = "adminclient1-1", SecurityStamp = Guid.NewGuid(), Email = "adminclient1-1@example.com", FirstName = "John", LastName = "Doe", LanguageId = 1, PhoneNumber = "1234567890", CreatedBy = 1, CreatedDate = DateTime.UtcNow},
                new User { Id = 2, Password = "clientuser1-2", SecurityStamp = Guid.NewGuid(), Email = "clientuser1-2@example.com", FirstName = "Jane", LastName = "Smith", LanguageId = 1, PhoneNumber = "0987654321", CreatedBy = 2, CreatedDate = DateTime.UtcNow },
                new User { Id = 3, Password = "clientuser1-3", SecurityStamp = Guid.NewGuid(), Email = "clientuser1-3@example.com", FirstName = "Alice", LastName = "Johnson", LanguageId = 1, PhoneNumber = "2345678901", CreatedBy = 3, CreatedDate = DateTime.UtcNow },
