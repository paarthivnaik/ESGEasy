    ...
    public class DataModelSeeder
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ModelConfiguration>().HasData(
                new ModelConfiguration { Id = 10000, DataModelId = 1, RowId = 1, ColumnId = 4, FilterId = 5, ViewType = ModelViewTypeEnum.Value, State = StateEnum.active, CreatedBy = 1, CreatedDate = DateTime.UtcNow, LastModifiedBy = 1, LastModifiedDate = DateTime.UtcNow },
                new ModelConfiguration { Id = 10001, DataModelId = 2, RowId = 1, ColumnId = 4, FilterId = 5, ViewType = ModelViewTypeEnum.Value, State = StateEnum.active, CreatedBy = 1, CreatedDate = DateTime.UtcNow, LastModifiedBy = 1, LastModifiedDate = DateTime.UtcNow });
        }
    }
}
