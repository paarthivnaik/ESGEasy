    ...
    public class DataModelSeeder
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Domain.Entities.DataModels.DataModel>().HasData(
                new Domain.Entities.DataModels.DataModel { Id = 1, ModelName = "Default Model",Purpose = "This Model is default model",IsDefaultModel = true, State = StateEnum.active, OrganizationId = 1, CreatedBy = 1, CreatedDate = DateTime.UtcNow, LastModifiedBy = 1, LastModifiedDate = DateTime.UtcNow });
