    ...
    public static class OrganizationUsersSeed
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<OrganizationUser>().HasData(
                ...
                new OrganizationUser { Id = 1, OrganizationId = 7, UserId = 1, CreatedBy = 1, CreatedDate = DateTime.UtcNow },
                new OrganizationUser { Id = 2, OrganizationId = 7, UserId = 2, CreatedBy = 1, CreatedDate = DateTime.UtcNow },
                new OrganizationUser { Id = 3, OrganizationId = 7, UserId = 3, CreatedBy = 1, CreatedDate = DateTime.UtcNow },
